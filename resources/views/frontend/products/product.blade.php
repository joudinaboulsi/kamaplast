                            ...
                            @foreach ($images as $i)
                                @if ($i->is_primary != 1)
                                    <a href="{{ getenv('S3_URL') }}/products/large/{{ $i->img }}">
                                        <img src="{{ getenv('S3_URL') }}/products/{{ $i->img }}"
                                            class="img-responsive" alt="img">
                                    </a>
                                @endif
                            @endforeach
                ...
                <div class="col-lg-6 col-md-6 col-sm-5">
                            ...
                            @else
                                ...
                                @if ($product[0]->enable_stock_mgmt == 1)
                                    ...
                                    @if ($variants[0]->stock_qty == 0 or $variants[0]->stock_qty == null)
                                        <h3 class="incaps no-margin" id="in_stock"><i
                                                class="fa fa fa-times-circle color-out"></i> Out of stock</h3>
                                        <!-- If stock available -->
                                    @else
                                        <h3 class="incaps no-margin" id="in_stock"><i
                                                class="fa fa fa-check-circle-o color-in"></i> In stock
                                ...
                                @else
                                    ...
                                    @else
                                        <h3 class="incaps no-margin" id="in_stock"><i
                                                class="fa fa fa-check-circle-o color-in"></i> In stock </h3>
                                    @endif
                                @endif
                            @endif
                        </div>
                    ...
                    @foreach ($attributes as $attr)
                                        ...
                                        @foreach ($attrItems as $item)
                                            @if ($attr->attribute_id == $item->attribute_id)
                                                <label class="radio_container" style="font-weight:500;">
                                                    <input type="radio"
                                                        id="attribute_item_{{ $item->attribute_item_id }}"
                                                        name="attribute_{{ $attr->attribute_id }}"
                                                        class="attribute_selection main_attribute"
                        ...
                        @elseif($attr->is_main == 2)
                            ...
                            <h5> please select product color and desired quantity before add to cart.</h5>
                            <label class="no-margin-bottom">{{ $attr->name }}:</label>
                            <div class="row contentBox">
                                <div class="col-lg-12">
                                    <div class="">
                                            ...
                                            @if ($attr->attribute_id == $item->attribute_id)
                                                <label class="radio_container" style="font-weight:500;">
                                                    <input type="radio"
                                                        id="attribute_item_{{ $item->attribute_item_id }}"
                                                        name="attribute_{{ $attr->attribute_id }}"
                                                        class="attribute_selection" value="{{ $item->attribute_item_id }}"
                                                        dimmed="true"> <!-- DO NOT REMOVE INPUT -->
                                                    <span class="checkmark" id="checkmark_{{ $item->attribute_item_id }}"
                                            ...
                                            @if ($attr->attribute_id == $item->attribute_id)
                                                <label class="radio_container" style="font-weight:500;">
                                                    ...
                                                    <span class="checkmark"
                                                        id="checkmark_{{ $item->attribute_item_id }}">
                                                        {{ $item->item_name }} </span>
                                                </label>
                                            @endif
                                        @endforeach
                    ...
                    <div class="contentBox">
                        ...
                        @if (count($attributes) != 0)
                            <input class="form-control qty_input_2" id="order_qty" type="number" value="1"
