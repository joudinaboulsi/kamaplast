...
class ProductsController extends Controller
{
    ...
    {   
        ...
        return view('frontend.products.product', array('product' => $product, 'images' => $images, 'attributes' => $attributes, 'attrItems' => $attrItems , 'variants' => $variants, 'similarProducts' => $similarProducts, 'linkedProducts' => $linkedProducts, 'prices' => $prices, 'actual_price' => $actual_price, 'old_price' => $old_price));
    }
