...
@section('content')
    ...
    <section class="white-bg" id="section-category">
        ...
        <div class="container-fluid hidden-xs blue-bg">
            ...
            <div class="container">
                ...
                <div class="row">
                        ...
                        <div class="content-box">
                            <div class="content">
                                <a href="{{ route('about_path') }}" target="_blank">
                                    ...
                                    <img class="content-image" src="/images/1b.jpg">
                        ...
                        <div class="content-box">
                            <div class="content">
                                <a href="{{ route('odm_path') }}" target="_blank">
                                    <div class="content-overlay"></div>
                                    <img class="content-image" src="/images/2b.jpg">
                                    <div class="content-details fadeIn-bottom">
                    ...
                    <div class="col-sm-4">
                        <div class="content-box">
                            <div class="content">
                                <a href="{{ route('blog_path') }}" target="_blank">
                                    <div class="content-overlay"></div>
                                    <img class="content-image" src="/images/3b.jpg">
                                    <div class="content-details fadeIn-bottom">
                                        <p class="content-text">Discover more about Kamaplast’s blog.<br>
                                            Find more about recent trends, research and ideas in this section. </p>
                                    </div>
                                </a>
                            </div>
                            <h3>Resources</h3>
            ...
            <img src="/images/kamaplast.png" class="kama">
    ...
    <!-- Categories  -->
    <section class="section-hero white-bg hidden-xs hidden-sm" id="section-category"
    ...
    @if ($data['collections'])
        <!-- Collections  -->
        <section class="section-hero white-bg" id="section-collections" style="background:url('images/plastic.png')">
            <br><br>
            <div class="container-fluid">
