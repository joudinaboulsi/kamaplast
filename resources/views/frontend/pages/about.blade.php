    ...
    <div class="container main-container ">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="employees">
                    ...
                    <p class="employee-p"><img src="/images/about/1.png" width="50"> &nbsp; Products</p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="customer">
                    ...
                    <p class="customer-p"><img src="/images/about/2.png" width="35"> &nbsp; Countries</p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="design">
                    ...
                    <p class="design-p"><img src="/images/about/3.png" width="50"> &nbsp; Customers</p>
                </div>
            </div>
        </div>
                                ...
                                <div class="content-inner wow fadeInRight" data-wow-duration=".8s" data-wow-delay="0">
                                    ...
                                    <div class="about-content-text odm_text">
                                        <div style="display:flex">
                                            <img src="{{ asset('images/icons8-goal-50.png') }}" width="50">
        ...
        <div class="row has-equal-height-child footerOffset">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 col-xxs-12 is-equal">
                <div class="content-inner wow fadeInLeft" data-wow-duration=".8s" data-wow-delay="0">
                    <img src="images/about/trust.png" class="img-responsive" alt="img">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 col-xxs-12 is-equal">
                <div class="content-inner wow fadeInRight" data-wow-duration=".8s" data-wow-delay="0">
                    <img src="images/about/quality.png" class="img-responsive" alt="img">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 col-xxs-12 is-equal">
                <div class="content-inner wow fadeInRight" data-wow-duration=".8s" data-wow-delay="0">
                    <img src="images/about/determination.png" class="img-responsive" alt="img">
