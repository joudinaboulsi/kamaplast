            ...
            <div class="block-explore col-sm-3 col-xs-6">
                <div class="inner">
                    ...
                    <a href="{{ route('product_list_path', $seo_link) }}" class="img-block" style="border-radius: 15px;">
                        @if($c->img == '' || $c->img == null)
                            <img alt="{{$c->name}}" src="/images/placeholder-image.png" class="img-responsive" style="border-radius: 15px;">
                        @else
                            <img alt="{{$c->name}}" src="{{getenv('S3_URL')}}/categories/{{$c->img}}" class="img-responsive" style="border-radius: 15px;">
                        @endif
